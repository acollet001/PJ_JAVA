...
public class Quizz extends Chatbot {
		...
		if (arg1!=-1){
			...
			while (j<arg1){
				...
				try{
					...
					// Réponses correcte et incorrectes 
	...
	/* ----- Retourne le numéro de la réponse correcte ------ */
	...
	/* ----- Gestion des arguments du bot quizz ------ */
	private int checkArg(String[] argbot){
		...
		try{
			...
			System.out.println("[Quizz] L'argument et la réponse doivent être des entiers positifs! Je ne sais pas quoi faire avec "+argbot[0]);
			return -1;
		}
	}
